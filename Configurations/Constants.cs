namespace AnjeerMarket.Configurations;
...
public static class Constants
{
    ...
    public const string CART_ITEMS_PATH = @"..\..\..\..\AnjeerMarket\Database\cart_items.json";
    public const string CATEGORIES_PATH = @"..\..\..\..\AnjeerMarket\Database\categories.json";
    public const string ORDER_ITEMS_PATH = @"..\..\..\..\AnjeerMarket\Database\order_items.json";
}